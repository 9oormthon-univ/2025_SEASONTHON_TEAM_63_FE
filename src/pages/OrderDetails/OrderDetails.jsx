                ...
                {orders.map((order) => (
                    <div className="Order-card" key={order.id}>
                        ...
                        <div className="Order-price">
                            결제금액 <span className="Original-price">{order.originalPrice}원</span>
                            <span className="Discounted-price">{order.discountedPrice}원</span>
                            <span className="Discount-badge">{order.discount}% 할인</span>
                        </div>
                        <div className="Order-time">결제시간 {order.orderTime}</div>

                        <NavLink to="/" className="Review-btn">
                            리뷰 작성하기
                        </NavLink>
                    </div>
                ))}
